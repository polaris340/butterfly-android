...
public class HideableViewWrapper {
    ...
    public HideableViewWrapper(View view, Animation showAnimation, Animation hideAnimation) {
        this.view = view;
    ...
    public HideableViewWrapper(View view, int showAnimationRes, int hideAnimationRes) {
        this.view = view;
